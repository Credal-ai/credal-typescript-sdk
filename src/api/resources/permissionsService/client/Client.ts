...
export class PermissionsService {
    ...
    private async __checkResourceAuthorizationForUser(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Credal.CheckResourceAuthorizationResponse,
    ...
    private async __checkBulkResourcesAuthorizationForUser(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Credal.CheckBulkResourcesAuthorizationResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __listCachedAuthorizedResourcesForUser(
        ...
        if (_response.ok) {
            return { data: _response.body as Credal.AuthorizedResourceListPage, rawResponse: _response.rawResponse };
        }
